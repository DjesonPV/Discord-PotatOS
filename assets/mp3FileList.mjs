...
export const files = {
    ...
    bite : {
        file  : "bite-dans-mes-frites.mp3",
        title : "Il y a une bite dans mes frites !",
        description : "C'était moins une",
        volume : 0.5,
    },
    ...
    polish : {
        file  : "Polish_woman_sings.mp3",
        title : "Ooh Eeh Ooh Ah Aah",
        description : "Ting Tang Walla Walla Bing Bang",
        volume : 0.8,
    },
    ...
    ununun : {
        file  : "ununun.mp3",
        title : "ÜN ÜN ÜN",
        description : "𓀂𓀇𓀉𓀍𓀠𓁀𓁂𓀱𓁉𓀿𓀪𓁶𓂧𓂮𓂫𓃹𓃳𓄜𓄲𓄓𓅆𓅢𓅼𓆀𓆾𓈙𓉒𓉼𓊪𓋜𓋒𓍲𓎳𓁀𓄲𓅢",
        volume : 1.0,
    },
